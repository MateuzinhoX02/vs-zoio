...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Melhore!', 0.2], //From 0% to 19%
		['Horrível!', 0.4], //From 20% to 39%
		['Ruim demais!', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Boa!', 0.7], //69%
		['Bom!', 0.8], //From 70% to 79%
		['Daora!', 0.9], //From 80% to 89%
		['100% de aproveitamento', 1], //From 90% to 99%
		['100% de aproveitamento', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	function doStopSign(sign:Int = 0, fuck:Bool = false)
	{
		...
		daSign.frames = Paths.getSparrowAtlas('sign', 'preload/weeks/Tricky/Zapurgation/Sign_Post_Mechanic');

		daSign.setGraphicSize(Std.int(daSign.width * 1.34));
